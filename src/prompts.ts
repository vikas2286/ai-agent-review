...
export const PROMPTS = {
    REVIEW_FILE: (code: string, language: string, fileName: string) => `
...
`,
    ...
    REVIEW_SELECTION: (code: string, language: string, context?: string) => `
...
`,
    ...
    CHECK_SECURITY: (code: string, language: string) => `
...
`,
    ...
    SUGGEST_IMPROVEMENTS: (code: string, language: string) => `
...
`,
    ...
    GENERATE_TESTS: (code: string, language: string, framework?: string) => `
...
`,
    ...
    ADD_DOCUMENTATION: (code: string, language: string) => `
...
`,
    ...
    CHAT_CONTEXT: (code?: string, language?: string) => `
...
`,
    ...
    WORKSPACE_REVIEW: (filesList: string[], fileContents: Map<string, string>) => {
